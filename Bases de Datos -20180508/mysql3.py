...
class MyDialog1 ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"CRUD Productos", pos = wx.DefaultPosition, size = wx.Size( -1,320 ), style = wx.DEFAULT_DIALOG_STYLE )
        
        #self.SetSizeHints( wx.DefaultSize, wx.DefaultSize )
        #Clase Padre formulario superior
        self.frm_padre=parent
        
        btn2 = wx.BoxSizer( wx.VERTICAL )
        ...
        self.txt3 = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 160,-1 ), 0 )
        ...
        self.m_staticText81 = wx.StaticText( self, wx.ID_ANY, u"Categoria", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText81.Wrap( -1 )
        fgSizer1.Add( self.m_staticText81, 0, wx.ALL, 5 )
        
        m_comboBox1Choices = [ u"0", u"1" ]
        self.m_comboBox1 = wx.ComboBox( self, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.Size( 300,-1 ), m_comboBox1Choices, 0 )
        fgSizer1.Add( self.m_comboBox1, 0, wx.ALL, 5 )
        
        btn2.Add( fgSizer1, 1, wx.EXPAND, 5 )
        ...
        btn2.Add( fgSizer2, 1, wx.EXPAND, 5 )
        ...
        #MODAL PARA mensajes
        self.dial = wx.MessageDialog(None, 'CONSULTA CORRECTA', 'Info', wx.OK|wx.CENTRE)
    ...
    def btnAceptar( self, event ):
        if ( self.lbl1.GetLabel()=='EDITAR'):
            ...
            self.cat=1
            self.exento=0   
            sql="""UPDATE producto SET barcode=%s,id_categoria=%s,descripcion=%s,exento=%s, costo=%s,precio=%s
                WHERE id_producto=%s"""
            valores=(self.barcode,self.cat,self.descripcion,self.exento,self.costo,self.precio,self.id_producto)
            typesql='U'
            ...
            self.cat="1"
            self.exento=0
            sql="""INSERT INTO producto (barcode,id_categoria,descripcion,exento,costo,precio) VALUES (%s, %s, %s, %s,%s,%s)"""
