...
class FrmGraficar ( wx.Frame ):
    ...
    def RevisarIntervalos(self, valor):
        try:
            valor = float(valor)
            return valor
        except:
    ...
    def Graficar( self, event ):
        ...
        self.int1 = self.RevisarIntervalos(str(self.txtIntervalo1.GetValue()))
        self.int2 = self.RevisarIntervalos(str(self.txtIntervalo2.GetValue()))
        f=self.txtFuncion.GetValue()
        f=f.lower()  
        
        x = linspace(self.int1, self.int2)
